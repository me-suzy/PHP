 ...
 *
 * @version $Id: Error.php,v 1.18 2003/06/06 13:20:01 adam Exp $
 * @author  Steven Levin <steven@NOSPAM.tux.appstate.edu>
 * @package Core
 */
class PHPWS_Error extends PHPWS_Item {
  ...
  function message($contentVar = NULL, $title = NULL) {
    ...
    if($this->_status == "exit") {
      echo $GLOBALS['core']->processTemplate($errorTags, "core", "error.tpl");
      exit();
	...
	$GLOBALS[$contentVar]['content'] = NULL;
      ...
      $GLOBALS[$contentVar]['content'] .= $GLOBALS['core']->processTemplate($errorTags, "core", "error.tpl");
    }
  }
  ...
  function isError($value) {
    return (is_object($value) && (get_class($value) == 'phpws_error' || is_subclass_of($value, 'phpws_error')));
  }
