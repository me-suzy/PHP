 ...
 *
 * @version $Id: EZform.php,v 1.46 2003/07/08 16:22:29 matt Exp $
...
class EZform {
  ...
  function getStart(){
    if (!isset($this->_action)){
      if (isset($GLOBALS["core"]->home_http))
   ...
   * It will also create a DEFAULT_SUBMIT button. This is not translated however.
   * 
