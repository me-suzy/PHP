 ...
 *
 * @version $Id: Pager.php,v 1.12 2003/05/08 19:14:17 steven Exp $
...
class PHPWS_Pager {
  ...
  function getSectionLinks() {
	...
	if($x == $this->section){
	  ...
	  $sectionLinks .= "&#160;<a href=\"" . $this->_linkBack . "&amp;PAGER_limit=" . $this->limit . "&amp;PDA_start=" . ($this->limit * ($x - 1)) . "&amp;PAGER_section=" . $x . $this->_anchor . "\"";
	  if(!is_null($this->_class)) {
	    $sectionLinks .= " class=\"" . $this->_class . "\"";
	  }
	  $sectionLinks .= ">" . $x . "</a>&#160;\n";
