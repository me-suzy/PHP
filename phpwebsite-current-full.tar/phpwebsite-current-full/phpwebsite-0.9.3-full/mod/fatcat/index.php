...
if (isset($_REQUEST["fatcat"])){
  ...
  if ($section == "admin" && $_SESSION["OBJ_user"]->allow_access("fatcat")){
    ...
    case "deleteCategoryAction":
      phpws_fatcat_category::deleteCategory($_REQUEST['cat_id']);
  ...
  if ($section == "user"){
	...
	$moduleTitle = NULL;
      $CNT_fatcat["title"] = $_SESSION["OBJ_fatcat"]->categories[$_REQUEST["fatcat_id"]]->title;
      $CNT_fatcat["content"] = $_SESSION["OBJ_fatcat"]->viewCategory($_REQUEST["fatcat_id"], $moduleTitle);
      break;
