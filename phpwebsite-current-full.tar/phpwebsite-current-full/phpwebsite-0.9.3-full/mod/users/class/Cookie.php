 ...
 *
 * @version $Id: Cookie.php,v 1.23 2003/03/24 14:33:10 matt Exp $
...
<div class=\"bg_light\">". $GLOBALS["core"]->formCheckBox("allow_cookies", 1, $allow_cookies)." ".$_SESSION["translate"]->it("Allow Cookies")."?</div><br />
".$_SESSION["translate"]->it("Time Limit")." ".$GLOBALS["core"]->formTextField("timelimit", $timelimit, 3)."<br /><br />
".$GLOBALS["core"]->formCheckBox("secure",1, $secure)." ".$_SESSION["translate"]->it("Secure Cookie")." <br /><br />";

    $content .= $GLOBALS["core"]->formSubmit($_SESSION["translate"]->it("Update Cookie Settings"))."
</form>";
