...
class PHPWS_ControlPanel_Link extends PHPWS_Item {
  ...
  function get() {
    ...
    return $GLOBALS["core"]->processTemplate($tags, "controlpanel", "link/view.tpl");
  }
  ...
  function getImage() {
	...
	$dir = PHPWS_SOURCE_HTTP . "mod/" . $this->_module . "/img/";
	$html = "<img src=\"http://" . $dir . $this->_image["name"] . "\" width=\"" . $this->_image["width"] .
	   "\" height=\"" . $this->_image["height"] . "\" alt=\"" . $this->_image["alt"] . "\" title=\"" . $this->_image["alt"] . "\" border=\"0\" />";
	return $html;
      } else {
	return NULL;
      }
