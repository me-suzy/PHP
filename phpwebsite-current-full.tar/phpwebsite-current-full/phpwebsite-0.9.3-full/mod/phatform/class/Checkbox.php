 ...
 * Checkbox item
 *
 * @version $Id: Checkbox.php,v 1.26 2003/06/04 18:10:14 adam Exp $
...
class PHAT_Checkbox extends PHAT_Element {
  ...
  function view() {
    ...
    return $GLOBALS['core']->processTemplate($viewTags, "phatform", "checkbox/view.tpl");
  } // END FUNC view
  ...
  function edit() {
    ...
    $elements[0] .= $GLOBALS['core']->processTemplate($editTags, "phatform", "checkbox/edit.tpl");
