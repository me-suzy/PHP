 ...
 * Textfield item
 *
 * @version $Id: Textfield.php,v 1.31 2003/06/04 18:10:14 adam Exp $
...
class PHAT_Textfield extends PHAT_Element {
  ...
  function view() {
    ...
    return $GLOBALS['core']->processTemplate($viewTags, "phatform", "textfield/view.tpl");
  } // END FUNC edit
  ...
  function edit() {
    ...
    $elements[0] .= $GLOBALS['core']->processTemplate($editTags, "phatform", "textfield/edit.tpl");
  ...
  function save() {
    ...
    $size = $GLOBALS['core']->parseInput($_REQUEST['PHAT_ElementSize']);
    ...
    $maxsize = $GLOBALS['core']->parseInput($_REQUEST['PHAT_ElementMaxsize']);
