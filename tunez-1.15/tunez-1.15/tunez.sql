...
#
# Host: localhost
# Generation Time: Jun 24, 2003 at 10:43 PM
...
CREATE TABLE albums (
  album_id mediumint(8) unsigned NOT NULL UNIQUE auto_increment,
...
CREATE TABLE artists (
  artist_id mediumint(9) unsigned NOT NULL UNIQUE auto_increment,
