...
DATE_FORMAT(play.timestamp,'%W, %M %D (%l:%i %p)') as timestamp, timesPlayed from
play LEFT JOIN songs ON play.song_id=songs.song_id LEFT JOIN artists on
songs.artist_id=artists.artist_id WHERE play.play_id=$_GET[play_id]";
...
echo "<p>The following people were responsible for playing
<b>$play->artist_name - $play->songtitle</b> at $play->timestamp</p>";
...
$kweerie .= " WHERE c.play_id=$_GET[play_id]";
