...
while ($row = mysql_fetch_array($resultGroups))
{
    ...
    echo "<td><a href=\"admin_groups_edit.php?edit_group_id=" . $row[group_id] . "\">edit</a> / <a href=\"admin_groups_del.php?del_group_id=" . $row[group_id] . "\" onClick=\"javascript:return(checkDel())\" >del</a></td>";
    echo "</tr>\n";
}

echo "</table>";

echo "<form method=\"get\" action=\"admin_groups_add.php\">";
