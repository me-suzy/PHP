...
// +----------------------------------------------------------------------+
//
// $Id: refererpoint.php,v 1.5 2001/06/18 09:25:15 hitweb Exp $
...
function pointsite($liens_id) {
  ...
  header("Location: http://www.hitweb.org/") ;
  //header("Location: http://localhost/hitweb/") ;
}
